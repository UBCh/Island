...
public class Fox extends Animal {
    ...
    @ConfigurationAnimal(name = "Fox", specifications = Specifications.AGGRESSIVE, mass = 8D, numberOfAnimalsInCage = 30, speed = 2, numberOfStart = 3)
	...
	System.out.println("Fox be fruitful and multiply"+"+"+numberOfCubs);
	appetite = Appetite.HUNGRY;
	foodMass = 0;
	return animals;
    }
	...
	public void run() {
	    ...
	    System.out.println("Fox died of old age");
	    Thread.interrupted();
	}
    }
