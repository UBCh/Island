...
public class Eagle extends Animal {
    ...
    @ConfigurationAnimal(name = "Eagle", specifications = Specifications.AGGRESSIVE, mass = 6D, numberOfAnimalsInCage = 20, speed = 3, numberOfStart = 3)
	...
	System.out.println("Eagle be fruitful and multiply"+"+"+numberOfCubs);
	appetite = Appetite.HUNGRY;
	foodMass = 0;
	return animals;
    }
	...
	public void run() {
	    ...
	    System.out.println("Eagle died of old age");
	    Thread.interrupted();
	}
    }
